    ...
    def check_language(self):
        ...
        if not os.path.exists(file_path):
            data = {
                ...
                "parameter sigma": "Параметр SIGMA",
                "min distance": "Минимальная дистанция",
                "threshold abs": "Порог интенсивности",
                ...
                "Поиск локальный максимумов": "Поиск локальных максимумов",
