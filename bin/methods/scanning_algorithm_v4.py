...
class ScanningAlgorithmV4:
    ...
    def scan(self, data_params):
        ...
        print(f'Testing {ScanningAlgorithmV4.NAME} method')
        ...
        # Draw the outline
        img_res = cv2.drawContours(img, coins, -1, color=(0, 23, 223), thickness=2)
        ...
        return {
            'method_name': ScanningAlgorithmV4.NAME,
